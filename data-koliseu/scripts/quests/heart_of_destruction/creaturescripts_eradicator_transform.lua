...
function eradicatorTransform.onThink(creature)
	...
	if eradicatorReleaseT > 0 then
		...
		if eradicatorWeak == 0 then
			Game.createMonster("Spark of Destruction", Position(998, 954, 15), false, true)
			Game.createMonster("Spark of Destruction", Position(1003, 954, 15), false, true)
			Game.createMonster("Spark of Destruction", Position(998, 958, 15), false, true)
			Game.createMonster("Spark of Destruction", Position(1003, 958, 15), false, true)
		end
