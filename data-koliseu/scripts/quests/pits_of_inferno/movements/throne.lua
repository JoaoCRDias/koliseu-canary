...
function throne.onStepIn(creature, item, position, fromPosition)
	...
	if player:getStorageValue(throne.storage) ~= 1 then
		...
		player:setStorageValue(Storage.ThePitsOfInferno.ShortcutHubDoor, 1)
