local config = {
	[1] = {
		teleportPosition = Position(869, 1398, 7),
		bossName = "Ancient Lion Knight",
		requiredLevel = 200,
		timeToFightAgain = 20, -- In hour
		timeToDefeat = 3, -- In minutes
		destination = Position(1052, 1191, 7),
		bossPosition = Position(1053, 1186, 7),
		specPos = {
			from = Position(1042, 1177, 7),
			to = Position(1066, 1195, 7),
		},
		exitPosition = Position(870, 1398, 7),
	},
	[2] = {
		teleportPosition = Position(1051, 1193, 7),
		exitPosition = Position(870, 1398, 7),
	},
}
