local storagesTable = {
	{ storage = Storage.U12_30.FeasterOfSouls.FearFeasterKilled, bossName = "The Fear Feaster" },
	{ storage = Storage.U12_30.FeasterOfSouls.DreadMaidenKilled, bossName = "The Dread Maiden" },
	{ storage = Storage.U12_30.FeasterOfSouls.UnwelcomeKilled, bossName = "The Unwelcome" },
}
