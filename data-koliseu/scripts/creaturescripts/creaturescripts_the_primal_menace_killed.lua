...
function thePrimalMenaceDeath.onDeath(creature)
	...
	onDeathForDamagingPlayers(creature, function(creature, player)
		if player:getStorageValue(Storage.U12_90.PrimalOrdeal.Bosses.ThePrimalMenaceKilled) < 1 then
			player:setStorageValue(Storage.U12_90.PrimalOrdeal.Bosses.ThePrimalMenaceKilled, 1)
		end
