...
function AutoBroadCast.onThink(interval, lastExecution)
	...
	local messages = {
		...
		string.format("{yellow|[VIP]}: torne-se vip e receba bonus adicionais"),
		string.format("{blue|[COMANDOS]}: digite !commands para ver a lista de comandos"),
		string.format("{yellow|[FLASK SYSTEM]}: Utilize o comando !settings para manter ou remover os vials!"),
		string.format("{blue|[SETTINGS]}: Utilize o comando !settings para configurações do seu personagem!"),
		string.format("{green|[DISCORD]}: Acesse nosso discord em: https://discord.gg/s76qpDzh4Y"),
	}
