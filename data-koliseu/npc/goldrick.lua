local internalNpcName = "Goldrick"
...
npcConfig.shop = {
	...
	{ itemName = "blooded worm", clientId = 43857, sell = 6200 },

	{ itemName = "all loot", clientId = 60300, sell = 1 },
	--Alaistar-
	...
	{ itemName = "lesser marksman gem", clientId = 44605, sell = 2500 },
