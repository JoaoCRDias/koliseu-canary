...
| File                                                                 | Purpose                                                                             |
| -------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `data-koliseu/lib/linked_task_system/linked_task_lib.lua`            | Core library: configuration, room/task definitions, helper functions, reward system |
| `data-koliseu/lib/linked_task_system/linked_task_action.lua`         | Totem interaction handler (accept task, check progress, claim reward)               |
| `data-koliseu/lib/linked_task_system/linked_task_creaturescript.lua` | Monster death event - tracks kills for active task                                  |
| `data-koliseu/lib/linked_task_system/linked_task_globalevent.lua`    | Startup event - registers kill tracking on all task monsters                        |
| `data-koliseu/scripts/actions/linked_task_system_loader.lua`         | Loader script (autoloaded by revscriptsys)                                          |
| `data-koliseu/scripts/talkactions/player/linked_task.lua`            | `!linkedtask` command for progress checking                                         |
