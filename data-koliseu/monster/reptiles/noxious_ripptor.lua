...
monster.loot = {
	{ name = "Crystal Coin", chance = 22754, minCount = 1, maxCount = 2 },
	{ name = "Ripptor Scales", chance = 10922 },
	{ name = "Ultimate Health Potion", chance = 8984, minCount = 1, maxCount = 2 },
	{ name = "Ripptor Claw", chance = 7038, minCount = 1, maxCount = 2 },
	{ name = "Serpent Sword", chance = 1224 },
	{ name = "Sacred Tree Amulet", chance = 1156 },
	{ name = "Muck Rod", chance = 1096 },
	{ name = "Terra Legs", chance = 637 },
	{ name = "Wooden Spellbook", chance = 382 },
}
