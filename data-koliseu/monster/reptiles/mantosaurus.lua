...
monster.loot = {
	{ name = "Crystal Coin", chance = 21794, minCount = 1, maxCount = 2 },
	{ name = "Mantosaurus Jaw", chance = 16252 },
	{ name = "Ultimate Mana Potion", chance = 8211, minCount = 1, maxCount = 3 },
	{ name = "Silver Brooch", chance = 3332 },
	{ name = "Red Crystal Fragment", chance = 3034 },
	{ name = "Cyan Crystal Fragment", chance = 2558 },
	{ name = "Green Crystal Shard", chance = 2558 },
	{ name = "Coral Brooch", chance = 2057 },
	{ id = 3007, chance = 1215 }, -- Crystal Ring
	{ name = "Gold Ring", chance = 1164 },
	{ name = "Amulet of Loss", chance = 144 },
}
