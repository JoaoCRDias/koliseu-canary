...
monster.loot = {
	{ name = "Emerald Tortoise Shell", chance = 24301 },
	{ name = "Crystal Coin", chance = 13192, minCount = 1, maxCount = 3 },
	{ name = "Great Spirit Potion", chance = 11356, minCount = 1, maxCount = 2 },
	{ name = "Blue Crystal Shard", chance = 3425 },
	{ name = "Green Crystal Fragment", chance = 3357 },
	{ name = "Violet Gem", chance = 3357 },
	{ name = "Red Crystal Fragment", chance = 2847 },
	{ name = "Yellow Gem", chance = 2822 },
	{ name = "White Pearl", chance = 2754 },
	{ name = "Green Crystal Shard", chance = 2465 },
	{ name = "Green Gem", chance = 2439 },
	{ name = "Orichalcum Pearl", chance = 2244, minCount = 1, maxCount = 2 },
	{ id = 282, chance = 2057 }, -- Giant Shimmering Pearl (Green)
	{ id = 3039, chance = 2057 }, -- Red Gem
	{ name = "Black Pearl", chance = 1836, minCount = 1, maxCount = 2 },
}
