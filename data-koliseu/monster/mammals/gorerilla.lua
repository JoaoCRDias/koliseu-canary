...
monster.loot = {
	{ name = "Crystal Coin", chance = 17595, minCount = 1, maxCount = 2 },
	{ name = "Gorerilla Mane", chance = 16906 },
	{ name = "Gorerilla Tail", chance = 14501 },
	{ name = "Ultimate Mana Potion", chance = 9528, minCount = 1, maxCount = 3 },
	{ name = "Doublet", chance = 4998 },
	{ name = "Magma Coat", chance = 2074 },
	{ name = "Black Pearl", chance = 425, minCount = 1, maxCount = 2 },
	{ name = "Crystal Crossbow", chance = 93 },
	{ name = "Composite Hornbow", chance = 25 },
	{ name = "Ornate Crossbow", chance = 25 },
}
