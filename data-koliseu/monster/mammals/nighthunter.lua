...
monster.loot = {
	{ name = "Crystal Coin", chance = 29061 },
	{ name = "Nighthunter Wing", chance = 20714, minCount = 1, maxCount = 2 },
	{ name = "Ultimate Health Potion", chance = 10744, minCount = 1, maxCount = 3 },
	{ name = "Red Crystal Fragment", chance = 3383 },
	{ name = "Green Crystal Shard", chance = 3119 },
	{ name = "Cyan Crystal Fragment", chance = 2618 },
	{ name = "Yellow Gem", chance = 2499 },
	{ name = "Crystal Sword", chance = 1351 },
	{ name = "Warrior's Axe", chance = 1190 },
	{ name = "Spellbook of Mind Control", chance = 816 },
	{ name = "Stone Skin Amulet", chance = 722 },
}
