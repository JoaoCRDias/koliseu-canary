...
monster.loot = {
	{ name = "Crystal Coin", chance = 19924, minCount = 1, maxCount = 2 },
	{ name = "Great Spirit Potion", chance = 17646 },
	{ name = "Cry-Stal", chance = 10676, minCount = 1, maxCount = 2 },
	{ name = "Small Diamond", chance = 5117, minCount = 1, maxCount = 3 },
	{ name = "Rusted Armor", chance = 4743 },
	{ name = "Green Crystal Fragment", chance = 3646 },
	{ name = "Terra Boots", chance = 3646 },
	{ name = "Protection Amulet", chance = 1929 },
	{ name = "Violet Gem", chance = 1062 },
	{ name = "Gold Ring", chance = 510 },
	{ name = "Green Gem", chance = 357 },
	{ name = "Ring of the Sky", chance = 178 },
}
...
monster.attacks = {
	...
	{ name = "fear", interval = 8000, chance = 1, target = true },
}
