...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -2000, maxDamage = -5000, range = 7, shootEffect = CONST_ANI_THROWINGKNIFE, target = false },
...
monster.defenses = {
	defense = 50,
	armor = 45,
	{ name = "combat", interval = 6000, chance = 65, type = COMBAT_HEALING, minDamage = 1000, maxDamage = 2000, effect = CONST_ME_MAGIC_BLUE, target = false },
}
