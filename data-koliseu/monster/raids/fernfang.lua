...
monster.attacks = {
	...
	{ name = "combat", interval = 1000, chance = 13, type = COMBAT_HOLYDAMAGE, minDamage = -2000, maxDamage = -5000, range = 7, shootEffect = CONST_ANI_SMALLHOLY, effect = CONST_ME_HOLYDAMAGE, target = false },
	{ name = "combat", interval = 1000, chance = 25, type = COMBAT_MANADRAIN, minDamage = -1000, maxDamage = -3000, range = 7, effect = CONST_ME_MAGIC_RED, target = false },
}
