...
monster.summon = {
	maxSummons = 4,
	summons = {
		{ name = "Orshabaal", chance = 12, interval = 3000, count = 4 },
	},
}
...
monster.loot = {
	...
	{ id = 60648, chance = 500, maxCount = 2 },
	{ id = 60427, chance = 500, maxCount = 2 },
	{ id = 60428, chance = 500, maxCount = 2 },
	{ id = 60429, chance = 500, maxCount = 2 },
	{ id = 58051, chance = 500, maxCount = 2 },
	{ id = 58052, chance = 500, maxCount = 2 },
	{ id = 58053, chance = 500, maxCount = 2 },
	{ id = 58054, chance = 500, maxCount = 2 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -5000, maxDamage = -7000, range = 7, effect = CONST_ME_MAGIC_RED, target = false },
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_LIFEDRAIN, minDamage = -3000, maxDamage = -4500, length = 8, spread = 0, effect = CONST_ME_HITBYPOISON, target = false },
	{ name = "combat", interval = 2000, chance = 21, type = COMBAT_LIFEDRAIN, minDamage = -4500, maxDamage = -5000, radius = 6, effect = CONST_ME_POFF, target = false },
	-- poison
	{ name = "condition", type = CONDITION_POISON, interval = 2000, chance = 15, minDamage = -200, maxDamage = -400, range = 7, shootEffect = CONST_ANI_POISON, target = false },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_LIFEDRAIN, minDamage = -9000, maxDamage = -10000, range = 4, radius = 3, effect = CONST_ME_DRAWBLOOD, target = false },
	-- energy damage
	{ name = "condition", type = CONDITION_ENERGY, interval = 2000, chance = 18, minDamage = -3000, maxDamage = -4000, radius = 6, effect = CONST_ME_ENERGYHIT, target = false },
	-- fire
	{ name = "condition", type = CONDITION_FIRE, interval = 3000, chance = 20, minDamage = -5000, maxDamage = -6000, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true },
}
