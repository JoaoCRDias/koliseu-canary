...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_EARTHDAMAGE, minDamage = -2000, maxDamage = -5000, range = 1, radius = 1, effect = CONST_ME_POISONAREA, target = true },
}

monster.defenses = {
	defense = 50,
	armor = 45,
	{ name = "combat", interval = 1000, chance = 18, type = COMBAT_HEALING, minDamage = 1000, maxDamage = 2000, effect = CONST_ME_MAGIC_BLUE, target = false },
}
