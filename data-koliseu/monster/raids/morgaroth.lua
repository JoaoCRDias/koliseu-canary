...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_FIREDAMAGE, minDamage = -5000, maxDamage = -12000, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true },
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_ENERGYDAMAGE, minDamage = -4000, maxDamage = -10000, length = 8, spread = 3, effect = CONST_ME_ENERGYHIT, target = false },
	...
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_MANADRAIN, minDamage = -2000, maxDamage = -5000, radius = 5, effect = CONST_ME_HITAREA, target = true },
	{ name = "speed", interval = 2000, chance = 15, speedChange = -800, range = 7, effect = CONST_ME_SOUND_RED, target = false, duration = 20000 },
}
...
monster.defenses = {
	...
	{ name = "combat", interval = 5000, chance = 20, type = COMBAT_HEALING, minDamage = 4000, maxDamage = 6000, effect = CONST_ME_MAGIC_BLUE, target = false },
