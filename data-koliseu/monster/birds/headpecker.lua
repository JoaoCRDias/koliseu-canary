...
monster.loot = {
	{ name = "Crystal Coin", chance = 29886 },
	{ name = "Headpecker Beak", chance = 9656 },
	{ name = "Headpecker Feather", chance = 6477, minCount = 1, maxCount = 5 },
	{ name = "Furry Club", chance = 4726 },
	{ id = 3595, chance = 4207, minCount = 1, maxCount = 3 }, -- Carrot
	{ name = "Knife", chance = 3621 },
	{ name = "Spike Sword", chance = 3434 },
	{ name = "War Hammer", chance = 1946 },
	{ name = "Titan Axe", chance = 1462 },
	{ name = "Blue Gem", chance = 1326 },
	{ name = "Wand of Starstorm", chance = 833 },
	{ name = "Gold Ingot", chance = 773 },
}
