...
monster.loot = {
	{ name = "Sulphur Powder", chance = 33524 },
	{ name = "Crystal Coin", chance = 18963, minCount = 1, maxCount = 2 },
	{ name = "Ultimate Mana Potion", chance = 10956, minCount = 1, maxCount = 2 },
	{ name = "Yellow Gem", chance = 2397 },
	{ id = 282, chance = 2082 }, -- Giant Shimmering Pearl (Green)
	{ name = "Slightly Rusted Legs", chance = 2057 },
	{ name = "Knight Legs", chance = 2006 },
	{ id = 3039, chance = 1861 }, -- Red Gem
	{ name = "Warrior's Shield", chance = 1496 },
	{ id = 23533, chance = 943 }, -- Ring of Red Plasma
	{ name = "Fire Sword", chance = 654 },
	{ name = "Crystal Crossbow", chance = 433 },
}
