local mType = Game.createMonsterType("Demonic Beholder")
local monster = {}

monster.description = "a demonic beholder"
...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "I will crush you!", yell = false },
	{ text = "Your soul is mine!", yell = false },
	{ text = "Feel the wrath of the beholder!", yell = false },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -4279, maxDamage = -5558, range = 7, shootEffect = CONST_ANI_FIRE, target = false },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -4279, maxDamage = -5558, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_SMALLCLOUDS, target = false },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -4279, maxDamage = -5558, range = 7, shootEffect = CONST_ANI_POISON, target = false },
