local mType = Game.createMonsterType("Flaming Bastard")
local monster = {}

monster.description = "a flaming bastard"
...
monster.voices = {
	...
	chance = 10,
	{ text = "BURN!", yell = true },
	{ text = "Everything turns to ash!", yell = false },
	{ text = "You will be incinerated!", yell = false },
}
...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, type = COMBAT_FIREDAMAGE, minDamage = 0, maxDamage = -4725, condition = { type = CONDITION_FIRE, totalDamage = 150, interval = 2000 } },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -3840, maxDamage = -4988, radius = 3, effect = CONST_ME_FIREAREA, target = false },
}
