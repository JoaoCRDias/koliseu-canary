...
local mType = Game.createMonsterType("Linked Tasks")
local monster = {}

monster.description = "a linked tasks"
...
monster.voices = {
	interval = 5000,
	chance = 10,
	{text = "Linked tasks is here!", yell = false}
}
...
mType:registerEvent("LinkedTaskLooktypeChanger")
