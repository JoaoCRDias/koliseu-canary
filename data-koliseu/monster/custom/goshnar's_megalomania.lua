...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = -2400, maxDamage = -7500 },
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_DEATHDAMAGE, minDamage = -4650, maxDamage = -7860, length = 8, spread = 0, effect = CONST_ME_MORTAREA, target = false },
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_DEATHDAMAGE, minDamage = -4650, maxDamage = -7860, length = 8, spread = 0, effect = CONST_ME_BLACK_BLOOD, target = false },
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_DEATHDAMAGE, minDamage = -3150, maxDamage = -6060, length = 8, spread = 3, effect = CONST_ME_GHOST_SMOKE, target = false },
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_DEATHDAMAGE, minDamage = -3150, maxDamage = -6060, length = 8, spread = 3, effect = CONST_ME_SMALLCLOUDS, target = false },
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_DEATHDAMAGE, minDamage = -2850, maxDamage = -4200, radius = 3, effect = CONST_ME_MORTAREA, target = true },
	{ name = "soulwars fear", interval = 35000, chance = 100, target = true },
	{ name = "combat", interval = 30000, chance = 100, type = COMBAT_LIFEDRAIN, minDamage = -3000, maxDamage = -4500, length = 8, radius = 5, spread = 0, effect = CONST_ME_PINK_ENERGY_SPARK, target = true },
}
