-- Supreme Vocation summit demon — ICE element.
local mType = Game.createMonsterType("Ysvira the Glacier Maw")
local monster = {}

monster.description = "Ysvira the Glacier Maw"
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_ICEDAMAGE, minDamage = -19500, maxDamage = -25500, range = 7, radius = 4, shootEffect = CONST_ANI_ICE, effect = CONST_ME_ICEAREA, target = true },
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_ICEDAMAGE, minDamage = -17500, maxDamage = -22500, length = 8, spread = 3, effect = CONST_ME_ICEATTACK, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -18000, maxDamage = -23000, radius = 3, effect = CONST_ME_ICETORNADO, target = false },
}
