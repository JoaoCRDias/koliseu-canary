local mType = Game.createMonsterType("Doomcurrent Ogre")
local monster = {}

monster.description = "a doomcurrent ogre"
...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "DOOM AWAITS!", yell = true },
	{ text = "SUFFER!", yell = true },
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 17, type = COMBAT_ENERGYDAMAGE, minDamage = -4872, maxDamage = -6327, range = 7, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -4872, maxDamage = -6327, range = 7, radius = 2, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA, target = false },
