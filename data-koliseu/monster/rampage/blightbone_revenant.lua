local mType = Game.createMonsterType("Blightbone Revenant")
local monster = {}

monster.description = "a blightbone revenant"
...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "YOUR FLESH WILL ROT!", yell = true },
	{ text = "DEATH IS ETERNAL!", yell = true },
}
