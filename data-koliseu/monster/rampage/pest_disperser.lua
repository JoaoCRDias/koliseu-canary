local mType = Game.createMonsterType("Pest Disperser")
local monster = {}

monster.description = "a pest disperser"
...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "SPREAD THE SICKNESS!", yell = true },
	{ text = "NO CURE FOR THIS PLAGUE!", yell = true },
}
...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -6345, condition = { type = CONDITION_POISON, totalDamage = 200, interval = 2000 } },
	{ name = "combat", interval = 2000, chance = 17, type = COMBAT_EARTHDAMAGE, minDamage = -5157, maxDamage = -6698, range = 7, shootEffect = CONST_ANI_POISONARROW, effect = CONST_ME_BIGPLANTS, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -5157, maxDamage = -6698, range = 7, radius = 2, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA, target = false },
