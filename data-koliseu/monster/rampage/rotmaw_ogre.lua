local mType = Game.createMonsterType("Rotmaw Ogre")
local monster = {}

monster.description = "a rotmaw ogre"
...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "GRRAAAWWW!", yell = true },
	{ text = "ME HUNGRY!", yell = true },
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 17, type = COMBAT_ICEDAMAGE, minDamage = -4828, maxDamage = -6270, range = 7, shootEffect = CONST_ANI_ICE, effect = CONST_ME_ICEATTACK, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -4828, maxDamage = -6270, range = 7, radius = 2, shootEffect = CONST_ANI_POISONARROW, effect = CONST_ME_BIGPLANTS, target = false },
