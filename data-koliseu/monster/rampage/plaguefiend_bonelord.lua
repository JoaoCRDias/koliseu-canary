local mType = Game.createMonsterType("Plaguefiend Bonelord")
local monster = {}

monster.description = "a plaguefiend bonelord"
...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "THE BONES ROT WITH PLAGUE!", yell = true },
	{ text = "ETERNAL DECAY!", yell = true },
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 17, type = COMBAT_DEATHDAMAGE, minDamage = -5355, maxDamage = -6954, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = false },
