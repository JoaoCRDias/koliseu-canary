local mType = Game.createMonsterType("Servant Of The Ogres")
local monster = {}

monster.description = "a servant of the ogres"
...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "MASTER COMMANDS!", yell = true },
	{ text = "OBEY OR DIE!", yell = true },
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 17, type = COMBAT_FIREDAMAGE, minDamage = -4872, maxDamage = -6327, range = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -4872, maxDamage = -6327, range = 7, radius = 2, shootEffect = CONST_ANI_POISONARROW, effect = CONST_ME_BIGPLANTS, target = false },
