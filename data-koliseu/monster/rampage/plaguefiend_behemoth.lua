local mType = Game.createMonsterType("Plaguefiend Behemoth")
local monster = {}

monster.description = "a plaguefiend behemoth"
...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "THE PLAGUE DEVOURS!", yell = true },
	{ text = "KNEEL BEFORE DECAY!", yell = true },
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 17, type = COMBAT_EARTHDAMAGE, minDamage = -5355, maxDamage = -6954, range = 7, shootEffect = CONST_ANI_POISONARROW, effect = CONST_ME_BIGPLANTS, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -5355, maxDamage = -6954, range = 7, radius = 3, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA, target = false },
