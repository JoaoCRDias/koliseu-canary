...
local aditionalMonsters = {
	{ name = "Overcharged Demon", pos = Position(952, 1068, 15) },
	{ name = "Overcharged Demon", pos = Position(945, 1068, 15) },
}

local areaTopLeft = Position(942, 1058, 15)
local areaBottomRight = Position(958, 1078, 15)
...
local fireSpawnTopLeft = Position(945, 1066, 15)
local fireSpawnBottomRight = Position(952, 1073, 15)
