...
local aditionalMonsters = {
	{ name = "Overcharged Demon", pos = Position(945, 1065, 15) },
	{ name = "Overcharged Demon", pos = Position(953, 1065, 15) },
}

local areaTopLeft = Position(942, 1060, 15)
local areaBottomRight = Position(957, 1077, 15)

local effectInterval = 2000
local effectDuration = 5000

local forgemasterAreaTopLeft = Position(942, 1065, 15)
local forgemasterAreaBottomRight = Position(957, 1077, 15)
...
local fireSpawnTopLeft = Position(944, 1065, 15)
local fireSpawnBottomRight = Position(947, 1073, 15)
