local mType = Game.createMonsterType("Saurian Spellsinger")
local monster = {}

monster.description = "Saurian Spellsinger"
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_ENERGYDAMAGE, minDamage = -22000, maxDamage = -32000, range = 7, radius = 4, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYAREA, target = true },
	...
	{ name = "combat", interval = 2000, chance = 18, type = COMBAT_ENERGYDAMAGE, minDamage = -19000, maxDamage = -26000, radius = 3, effect = CONST_ME_BIGCLOUDS, target = false },
}
