local mType = Game.createMonsterType("Saurian Brute")
local monster = {}

monster.description = "Saurian Brute"
...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = -16000, maxDamage = -28000 },
	{ name = "combat", interval = 2000, chance = 28, type = COMBAT_PHYSICALDAMAGE, minDamage = -20000, maxDamage = -32000, range = 5, radius = 3, effect = CONST_ME_GROUNDSHAKER, target = false },
	{ name = "combat", interval = 2000, chance = 22, type = COMBAT_EARTHDAMAGE, minDamage = -18000, maxDamage = -27000, length = 8, spread = 3, effect = CONST_ME_HITBYPOISON, target = false },
	{ name = "speed", interval = 2000, chance = 12, speedChange = -400, range = 5, effect = CONST_ME_MAGIC_RED, target = true, duration = 6000 },
}

monster.defenses = { defense = 380, armor = 380, mitigation = 3.50 }
