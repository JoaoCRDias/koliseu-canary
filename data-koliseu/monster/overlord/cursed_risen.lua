local mType = Game.createMonsterType("Cursed Risen")
local monster = {}

monster.description = "Cursed Risen"
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 28, type = COMBAT_DEATHDAMAGE, minDamage = -22000, maxDamage = -32000, range = 4, radius = 4, effect = CONST_ME_MORTAREA, target = true },
	{ name = "combat", interval = 2000, chance = 22, type = COMBAT_LIFEDRAIN, minDamage = -18000, maxDamage = -27000, radius = 3, effect = CONST_ME_BLACKSMOKE, target = false },
	{ name = "speed", interval = 2000, chance = 14, speedChange = -500, range = 5, effect = CONST_ME_MAGIC_RED, target = true, duration = 8000 },
}
