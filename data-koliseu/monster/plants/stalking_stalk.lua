...
monster.loot = {
	{ name = "Stalking Seeds", chance = 18292 },
	{ name = "Crystal Coin", chance = 14084, minCount = 1, maxCount = 3 },
	{ name = "Small Diamond", chance = 6069, minCount = 1, maxCount = 3 },
	{ name = "Green Crystal Fragment", chance = 4275 },
	{ name = "Dragon Necklace", chance = 3859 },
	{ name = "Opal", chance = 3366, minCount = 1, maxCount = 2 },
	{ name = "Magma Coat", chance = 1836 },
	{ name = "Bow", chance = 1700 },
	{ name = "Green Gem", chance = 1513 },
	{ name = "Warrior's Axe", chance = 1445 },
	{ name = "Muck Rod", chance = 1113 },
}
