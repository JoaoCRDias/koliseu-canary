...
monster.loot = {
	...
	{ id = 43502, chance = 3000 }, -- cursed wood
}

monster.attacks = {
	{ name = "melee", interval = 3000, chance = 100, minDamage = -7500, maxDamage = -11500 },
	{ name = "combat", interval = 1000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -3500, maxDamage = -5000, length = 12, spread = 0, effect = 249, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -13000, maxDamage = -11500, length = 12, spread = 0, effect = 5, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -4500, maxDamage = -7500, length = 6, spread = 0, effect = CONST_ME_FIREAREA, target = false },
...
monster.defenses = {
	defense = 105,
	armor = 105,
	{ name = "combat", interval = 3000, chance = 10, type = COMBAT_HEALING, minDamage = 800, maxDamage = 1200, effect = 13, target = false },
}
