...
monster.loot = {
	{ name = "Great Spirit Potion", chance = 26061, minCount = 1, maxCount = 3 },
	{ name = "Undertaker Fangs", chance = 21879 },
	{ name = "Crystal Coin", chance = 12835, minCount = 1, maxCount = 3 },
	{ name = "Spider Silk", chance = 2992 },
	{ name = "Terra Boots", chance = 2881 },
	{ name = "Blue Crystal Shard", chance = 1564 },
	{ name = "Relic Sword", chance = 1402 },
	{ name = "Terra Legs", chance = 1394 },
	{ name = "Necrotic Rod", chance = 1190 },
	{ name = "Butterfly Ring", chance = 1054 },
	{ name = "Wand of Voodoo", chance = 816 },
	{ name = "Violet Gem", chance = 722 },
}
...
monster.attacks = {
	...
	{ name = "root wave", interval = 4000, chance = 3, target = true },
}
