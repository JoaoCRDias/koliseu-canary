...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_DEATHDAMAGE, minDamage = -4050, maxDamage = -5100, range = 7, radius = 5, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_GROUNDSHAKER, target = true },
	...
	{ name = "singlecloudchain", interval = 6000, chance = 40, minDamage = -5100, maxDamage = -7500, range = 6, effect = CONST_ME_ENERGYHIT, target = true },
}
