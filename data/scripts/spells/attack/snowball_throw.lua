...
spell:vocation("druid;true", "elder druid;true", "primal druid;true", "sorcerer;true", "master sorcerer;true", "arcane sorcerer;true", "knight;true", "elite knight;true", "titan knight;true", "paladin;true", "royal paladin;true", "celestial paladin;true", "monk;true", "exalted monk;true")
spell:register()
