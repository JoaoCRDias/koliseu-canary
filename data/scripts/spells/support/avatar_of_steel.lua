...
function spell.onCastSpell(creature, variant)
	...
	local relicBonus = creature:getStorageValue(920022)
	if relicBonus and relicBonus > 0 then
		...
		creature:sendTextMessage(MESSAGE_EVENT_ADVANCE, "[Relic] Avatar of Steel duration +" .. (relicBonus / 100) .. "% (+" .. extraDuration .. "ms = " .. duration .. "ms)")
	end
