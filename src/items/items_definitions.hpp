...
enum ReturnValue : uint16_t {
	...
	RETURNVALUE_ONLYRELICSINRELIQUARY,
	RETURNVALUE_CANNOTMOVEALTARITEMS,
...
enum ItemParseAttributes_t {
	...
	ITEM_PARSE_MANTRA,
	ITEM_PARSE_CHAINTARGETS,
	ITEM_PARSE_CHAINDISTANCE,
	ITEM_PARSE_CHAINBACKTRACKING,
	ITEM_PARSE_ISRELIQUARY,
	ITEM_PARSE_ISRELIC,
	ITEM_PARSE_ISRELICALTAR,
};
