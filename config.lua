...
dataPackDirectory = "data-koliseu"
...
-- Mining System (AFK zone-based only)
miningBaseChance = 3
miningChancePerLevel = 0.25
miningTriesPerAttempt = 1
miningAttackSpeedTries = 7
...
-- Base regeneration (without food effect)
baseHealthRegenInterval = 4000
baseManaRegenInterval = 6000

-- Regeneration with food effect
foodHealthRegenInterval = 3000
foodManaRegenInterval = 5000
